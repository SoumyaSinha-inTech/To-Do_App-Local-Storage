    ...
    <>
      ...
      <div>
        <div className="container" style={{ width: '600px', height: '200px', backgroundColor: 'white', borderRadius: '30px', marginTop: '40px' }}>
          <div>
            <h4 style={{ textIndent: '15px', paddingTop: '20px' }}>Add descriptions here</h4>
          </div>
          <div className="container-fluid">
            <form role="search">
              ...
              <input className="form-control me-2" type="search"  placeholder="description goes here.." aria-label="Search" style={{ border: 'none', backgroundColor: '#22004256', height: '40px', marginTop: '3px' }} />
